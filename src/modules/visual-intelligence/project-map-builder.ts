...
const AREAS: Area[] = [
  ...
  },
  {
    ...
    layer: 3,
    prefixes: [
      "src/modules/assistant-runtime/router.ts",
      "src/modules/assistant-runtime/intent-grammar.ts",
      "src/modules/assistant-runtime/planner.ts",
    ],
    detail: "Deterministic intent grammar plus governed planner fallback.",
  },
  {
    ...
    layer: 3,
    prefixes: ["src/modules/assistant-runtime/capabilities/"],
    detail: "Native Kern capabilities for work, knowledge, writes, R&D and desktop execution.",
  },
  {
    ...
    detail: "Conversation lifecycle, context, autonomy and result composition.",
  },
  {
    id: "advisor-support",
    label: "Advisor Compatibility Libraries",
    type: "COMPAT_SUPPORT",
    layer: 4,
    prefixes: ["src/modules/advisor/"],
    detail: "Proposal, challenge, LLM and compatibility facade libraries; not a runtime owner.",
  },
  {
    id: "model-gateway",
    label: "Model Gateway",
