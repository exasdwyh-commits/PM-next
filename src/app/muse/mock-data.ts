...
const employees: Employee[] = [
  { id: "e-hermes", name: "Kern", role: "部门助理 / PM", mark: "H", state: "working", currentFocus: "汇总三条产品线的本周阻塞点", load: 62, skills: ["拆解", "委派", "汇报"] },
...
const decisions: Decision[] = [
  ...
  {
    id: "d-2", title: "批准 Kern 修改产品字段", because: "助理提出把「目标人群」从泛人群改为血糖管理人群，业务事实修改必须经你批准。",
    ifIgnored: "提议挂起，后续研究继续按旧人群口径跑，可能白做。", tone: "warn", gate: "Proposal / Approval", missionId: "m-1",
    dueLabel: "48 小时内", raisedBy: "Kern · 部门助理",
    options: [
