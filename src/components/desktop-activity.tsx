    ...
    <section className="hermes-desktop-strip" aria-label="本机执行">
      ...
      {stuck ? (
        <div className="hermes-desktop-blocked" role="status">
          ...
          <details className="hermes-details hermes-desktop-dev-help"><summary>开发环境连接方式</summary><details className="hermes-details hermes-desktop-dev-help"><summary>开发环境连接方式</summary><code>npm run desktop</code></details></details>
        </div>
      ) : null}
