...
> **历史复现说明（2026-09-22）**：本文保留的是当时的缺陷现场，不代表当前实现。G2 空门已由 Formal G2 生产投入授权收口；G3 也已统一到 DecisionPacket。当前状态以 `docs/FORMAL_G2_PRODUCTION_GATE.md`、`docs/FORMAL_G3_LAUNCH_GATE.md` 与最新契约 §6 为准。
>
